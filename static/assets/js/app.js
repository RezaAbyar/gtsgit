...
(function ($) {
  ...
  function test(val){
      if (val !== isOnline) {
        if (val === 1) {
          alarm("info","ارتباط اینترنت شما بر قرار است")
          isOnline = 1
      }else{
      ...
      if (val === 2) {
          alarm("warning","ارتباط اینترنت شما بر قرار نیست")

      }
      }

 let a=sessionStorage.getItem("menuId");
if (a) {

    if (a < 100) {
        if (document.getElementById('sm1')) {
            document.getElementById('sm1').classList.add("open");
        }
    }
    if (a < 20) {
        if (document.getElementById('sm11')) {
            document.getElementById('sm11').classList.add("open");
        }
    }
    if (a > 19 && a < 30) {
        if (document.getElementById('sm111')) {

            document.getElementById('sm111').classList.add("open");
        }
    }
    if (a > 30 && a < 40) {
        if (document.getElementById('sm1111')) {

            document.getElementById('sm1111').classList.add("open");
        }
    }
    if (a > 100 && a < 200) {
        if (document.getElementById('sm101')) {

            document.getElementById('sm101').classList.add("open");
        }
        if (document.getElementById('sm102')) {
            document.getElementById('sm102').classList.add("open");
        }
    }
    if (a > 200 && a < 300) {
        if (document.getElementById('sm101')) {
        ...
        if (document.getElementById('sm103')) {
            document.getElementById('sm103').classList.add("open");
        }
    }
    if (a > 400 && a < 500) {
        if (document.getElementById('sm401')) {

            document.getElementById('sm401').classList.add("open");
        }
    }
    if (a > 300 && a < 400) {
        if (document.getElementById('sm301')) {

            document.getElementById('sm301').classList.add("open");
        }
    }
    if (a > 500 && a < 600) {
        if (document.getElementById('sm501')) {

            document.getElementById('sm501').classList.add("open");
        }
    }
        ...
        setTimeout(function () {
            $('.navigation .navigation-menu-body ul li a').each(function () {
                ...
                if ($this.next('ul').length) {
                    $this.append('<i class="sub-menu-arrow ti-angle-up" aria-hidden="true"></i>');
                }
            });
...
function getCaptchaService() {
    ...
    $.ajax({
     type: 'GET',
        ...
        const mlist = data.mylist

        document.getElementById('captcha').setAttribute("src", mlist.img);
        document.getElementById('captcha_key').value = mlist.id;
